...
namespace Ouster {
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        try {
            OusterRayData *sample = new OusterRayData();
    ...
    * ---------------------------------------------------------------------------- */
    ...
    OusterRayDataPlugin_copy_sample(
        ...
        const OusterRayData *src)
    {
        return ::Ouster::OusterRayDataPluginSupport_copy_data(dst,src);
    }
        ...
        ::dds::core::policy::DataRepresentationId representation)
    {
        ...
        try{
            ...
            try {
                ...
                (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OusterRayData >::get().native()
                ;
            } catch (...) {
                return RTI_FALSE;
            }
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool OusterRayDataPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        OusterRayData **sample, 
        RTIBool * drop_sample,
        struct RTICdrStream *cdrStream,
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        try {
            OusterSingleFiring *sample = new OusterSingleFiring();
            ::rti::topic::allocate_sample(*sample);
            return sample;
        } catch (...) {
            return NULL;
    ...
    OusterSingleFiringPluginSupport_copy_data(
        OusterSingleFiring *dst,
        const OusterSingleFiring *src)
    {
        try {
            *dst = *src;
        } catch (...) {
    ...
    * ---------------------------------------------------------------------------- */
    ...
    OusterSingleFiringPlugin_copy_sample(
        ...
        const OusterSingleFiring *src)
    {
        return ::Ouster::OusterSingleFiringPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        ::dds::core::policy::DataRepresentationId representation)
    {
        ...
        try{
            ...
            try {
                plugin.typeCode = (struct RTICdrTypeCode *)
                (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OusterSingleFiring >::get().native()
                ;
            } catch (...) {
                return RTI_FALSE;
            }
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool OusterSingleFiringPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        OusterSingleFiring **sample, 
        RTIBool * drop_sample,
        struct RTICdrStream *cdrStream,
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        try {
            OusterMsg *sample = new OusterMsg();
            ::rti::topic::allocate_sample(*sample);
            return sample;
        } catch (...) {
            return NULL;
    ...
    * ---------------------------------------------------------------------------- */
        ...
        RTICdrTypeCode *type_code)
    {
        try {
            ...
            programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
                ...
                (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OusterMsg >::get().native()
                ,
                &programProperty,
        ...
        void *containerPluginContext)
    {
        try {
            ...
            epd = PRESTypePluginDefaultEndpointData_new(
                ...
                OusterMsgPluginSupport_create_data,
            ...
            if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                serializedSampleMaxSize = ::Ouster::OusterMsgPlugin_get_serialized_sample_max_size(
                ...
                if (PRESTypePluginDefaultEndpointData_createWriterPool(
                    ...
                    ::Ouster::OusterMsgPlugin_get_serialized_sample_max_size, epd,
    ...
    OusterMsgPlugin_copy_sample(
        ...
        const OusterMsg *src)
    {
        return ::Ouster::OusterMsgPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        ::dds::core::policy::DataRepresentationId representation)
    {
        ...
        try{
            ...
            try {
                plugin.typeCode = (struct RTICdrTypeCode *)
                (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< OusterMsg >::get().native()
                ;
            } catch (...) {
                return RTI_FALSE;
            }
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool OusterMsgPlugin_deserialize_key(
        PRESTypePluginEndpointData endpoint_data,
        OusterMsg **sample, 
        RTIBool * drop_sample,
        struct RTICdrStream *cdrStream,
    ...
    * Plug-in Installation Methods
    * ------------------------------------------------------------------------ */
    struct PRESTypePlugin *OusterMsgPlugin_new(void) 
    { 
        ...
        ::Ouster::OusterMsgPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        ::Ouster::OusterMsgPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        ::Ouster::OusterMsgPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        ::Ouster::OusterMsgPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        ::Ouster::OusterMsgPlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        OusterMsgPlugin_create_sample;
        plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        OusterMsgPlugin_destroy_sample;
        ...
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        ::Ouster::OusterMsgPlugin_get_serialized_sample_max_size;
        ...
        OusterMsgPlugin_get_sample;
        plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        OusterMsgPlugin_return_sample;
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        ::Ouster::OusterMsgPlugin_get_key_kind;
        ...
        */
        ...
        try {
            plugin->typeCode = (struct RTICdrTypeCode *)
            &::rti::topic::dynamic_type< ::Ouster::OusterMsg >::get().native();
        } catch (...) {
            ::Ouster::OusterMsgPlugin_delete(plugin);
            return NULL;
        }
        #endif
        ...
        OusterMsgPlugin_get_buffer;
        plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        OusterMsgPlugin_return_buffer;
        ...
        static const char * TYPE_NAME = "Ouster::OusterMsg";
    ...
    void
    OusterMsgPlugin_delete(struct PRESTypePlugin *plugin)
    {
